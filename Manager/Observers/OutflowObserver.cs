...
public class OutflowObserver : IOutflowObserver
{

    /// <summary>
    /// Valores.
    /// </summary>
    private readonly Dictionary<int, List<IOutflowModelObserver>> Values = [];
    ...
    public void Add(int id, IOutflowModelObserver product)
    {

        // Si existe la lista.
        if (!Values.TryGetValue(id, out List<IOutflowModelObserver>? products))
        {
            // Nueva lista.
            products = [];
    ...
    /// </summary>
    /// <param name="product">Observable.</param>
    public void Remove(IOutflowModelObserver product)
    {
        // Obtener elemento.
